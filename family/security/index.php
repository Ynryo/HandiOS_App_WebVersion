        ...
        <div class="main-container">
            ...
            <div class="main-content security">
                <div class="cam-group">
                    ...
                    <video src="/assets/videos/cam-rushs-living-room.mp4" type="video/mp4" muted="muted" loop="loop"
                        autoplay="autoplay"></video>
                </div>
                <div class="cam-group">
                    <h2>Porte d'entrée</h2>
                    <video src="/assets/videos/cam-rushs-doorbell.mp4" type="video/mp4" muted="muted" loop="loop"
                        autoplay="autoplay"></video>
                </div>
                <div class="cam-group">
                    <h2>Cave</h2>
                    <video src="/assets/videos/cam-rushs-cellar.mp4" type="video/mp4" muted="muted" loop="loop"
                        autoplay="autoplay"></video>
                </div>
            </div>
        </div>
